...
data_bs_three = np.array([0.30, 0.40, 0.45, 0.6])
data_bs_one = np.array([2.00, 1.59, 1.50, 1.28])
...
# tricritical point
ax.scatter( .60, 1.28, zorder=2, color='r',  marker='*', s=1250)
...
ax.text( .65, .45, 'Liquid', fontsize=40 ) 
###
...
ax.text( .10, 1.55, 'Biaxial$^*$', fontsize=40 ) 
###
...
ax.text( .90, 1.65, 'Biaxial', fontsize=40 ) 
###
...
ax.text( 1.65, .65, 'Uniaxial', fontsize=40 ) 
###
...
plt.yticks(np.array([0.00, 0.25, 0.50, 0.75, 1.00, 1.25, 1.50, 1.75, 2.00]))
