...
data_bl_one = np.array([2.12, 2.10, 2.08])
data_bl_three = np.array([0.0, 0.2, 0.4])

data_bu_one = np.array([2.08, 1.92, 1.76])
data_bu_three = np.array([0.4, 1.2, 2.0])

data_ul_one = np.array([2.08, 1.76, 1.32, .64, .00])
data_ul_three = np.array([0.4, 0.8, 1.2, 1.6, 1.8])
...
for i in range(500):
    ...
    smooth_one = np.append(smooth_one, 2.08)
for i in range(500):
    smooth_three = np.append(smooth_three, 1.80)
    smooth_one = np.append(smooth_one, 0.00)
...
ax.text( .40, 1.15, '$O(3)$', fontsize=75 )
...
ax.text( .90, 2.35, '$D_{3h}$', fontsize=75 )
...
ax.text( 1.55, 1.30, '$D_{\\infty h}$', fontsize=75 )
###
