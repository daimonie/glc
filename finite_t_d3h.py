...
ax.text( .40, 1.15, 'Liquid', fontsize=40 )
...
ax.text( 1.40, 2.05, 'Biaxial', fontsize=40 )
...
ax.text( 1.55, 1.30, 'Uniaxial', fontsize=40 )
###
...
plt.yticks(np.array([0.00, 0.25, 0.50, 0.75, 1.00, 1.25, 1.50, 1.75, 2.00, 2.25]))
