...
data_bs_one = np.array([3.0, 2.10])
bs_three, bs_one = smooth_bootstrap(data_bs_three, data_bs_one, 100)

data_sl_three = np.array([0.00, 0.20])
data_sl_one = np.array([2.12, 2.10])
...
smooth_one = np.append( data_bu_one, data_bl_one)
smooth_three = np.append(data_bu_three, data_bl_three)
