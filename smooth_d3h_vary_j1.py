...
data_d3h_dinfh_coup = np.array([0.0, 0.5, 1.0, 1.5, 2.0, 2.5, 3.0])
data_d3h_dinfh_crit = 1.0/np.array([float("Inf"), 3.62, 1.82, 1.24, .98, .79, .65])
d3h_dinfh_coup, d3h_dinfh_crit = smooth_bootstrap( data_d3h_dinfh_coup, data_d3h_dinfh_crit, 100)

data_dinfh_03_coup = np.array([0.0, 0.5, 0.7, 1.0, 1.3, 1.5, 1.7, 2.0, 2.5, 3.0])
data_dinfh_03_crit = 1.0/np.array([1.8, 1.55, 1.44, 1.26, 1.12, 1.03, .96, .85, .72, .65])
dinfh_03_coup, dinfh_03_crit = smooth_bootstrap( data_dinfh_03_coup, data_dinfh_03_crit, 100)

data_d3h_03_coup = np.array([3.0, 3.5, 4.0])
data_d3h_03_crit = 1.0/np.array([.65, .58, .51])
d3h_03_coup, d3h_03_crit = smooth_bootstrap( data_d3h_03_coup, data_d3h_03_crit, 100)


composite_coup = data_d3h_dinfh_coup
composite_crit = data_d3h_dinfh_crit


composite_coup = np.append(composite_coup, data_d3h_03_coup)
composite_crit = np.append(composite_crit, data_d3h_03_crit)

for i in range(5): 
    composite_coup = np.append(composite_coup, 3.0)
    composite_crit = np.append(composite_crit, 1.00/0.65)
    composite_coup = np.append(composite_coup, 2.5)
    composite_crit = np.append(composite_crit, 1.00/0.79)

    
d3h_dinfh_coup, d3h_dinfh_crit = smooth_bootstrap2(composite_coup,composite_crit, 100, data_d3h_dinfh_coup)
d3h_03_coup, d3h_03_crit = smooth_bootstrap2(composite_coup,composite_crit, 100, data_d3h_03_coup)



composite_coup = data_dinfh_03_coup
composite_crit = data_dinfh_03_crit
...
for i in range(5): 
    composite_coup = np.append(composite_coup, 3.0)
    composite_crit = np.append(composite_crit, 1.00/0.66)
for i in range(5): 
    composite_coup = np.append(composite_coup, 3.5)
    composite_crit = np.append(composite_crit, 1.00/0.58)

    
dinfh_03_coup, dinfh_03_crit = smooth_bootstrap2(composite_coup,composite_crit, 100, data_dinfh_03_coup) 



coup = np.array([]) 
coup = np.append(coup, data_d3h_dinfh_coup) 
coup = np.append(coup, data_dinfh_03_coup) 
coup = np.append(coup, data_d3h_03_coup) 

crit = np.array([]) 
crit = np.append(crit, data_d3h_dinfh_crit) 
crit = np.append(crit, data_dinfh_03_crit) 
crit = np.append(crit, data_d3h_03_crit) 
###
if max_x == 'auto':
    min_x = np.min(coup)
    max_x = np.max(coup)
...
color_count += 1
ax.scatter( data_d3h_dinfh_coup, data_d3h_dinfh_crit, zorder=1, color=colours_markers[color_count],  marker=shapes[color_count], s=marker_size)
...
###plot smooth
if False:
    plt.plot(d3h_dinfh_coup, d3h_dinfh_crit, "%s--" % colours_markers[0])
    plt.plot(dinfh_03_coup, dinfh_03_crit, "%s--" % colours_markers[0])
    plt.plot(d3h_03_coup, d3h_03_crit, "%s--" % colours_markers[0])
###
...
#ax.text( 2.5, 0.75, '$D_{3h}$', fontsize=40 ) 
ax.text( 2.5, 0.75, '$D_{3h}$', fontsize=75 ) 
###
...
#ax.text( 2.00, 1.50, '$O(3)$', fontsize=40 )
ax.text( 2.00, 1.50, '$O(3)$', fontsize=75 ) 
###
...
#ax.text( 0.55, 0.55, '$D_{\infty h}$', fontsize=40 ) 
ax.text( 0.15, 0.4, '$D_{\infty h}$', fontsize=75 ) 
###
###labels
...
plt.xticks(np.array([0.00, 1.00, 2.00, 3.00, 4.00]))
plt.yticks(np.linspace(min_y, max_y, 5))
plt.yticks(np.array([0.00, 0.50, 1.00, 1.50, 2.00]))
